				...
				<div class="inner_breadcrumb">
					...
					<ul class="short">
                        ...
                        <li>
							...
							<a href="http://localhost/E-Commerce%20Website%20PHP%20and%20MYSQL/CODE/ECOMMERCE-PUBLIC/goggles-web_Free07-08-2018_1255464790/web/products.php?id=<?php echo $row['category_id']?>"><?php echo $row['category_name'];?></a>
							<i>|</i>
						</li>
						<?php
								$query= "SELECT * FROM products where product_id = {$_GET['id']}";
											...
											<div class="googles single-item singlepage">
													<form action="#" method="post">
                                                        ...
                                                        $rows = mysqli_fetch_assoc($result);
                                                            ...
                                                            echo "<button name='set'>Set</button><br>";
